...
SmartContract.prototype = {
  ...
  deposit: function (rawTermIndex) {
    ...
    let currentDeposit = this.deposit.get(walletToCheck) || new BigNumber(0);
    ...
    // Check with terms
    let tarifIndex = new BigNumber(rawTermIndex);
    if (this.terms[tarifIndex] === undefined){
