...
var TheoryAccountContract = function() {
...
TheoryAccountContract.prototype = {
    init: function() {
        // todo
    },
    ...
    save: function(value) {
        ...
        theory.value = value;
        theory.author = from;
        theory.date = Date.parse(new Date());   // 获取当前时间戳
...
module.exports = TheoryAccountContract;