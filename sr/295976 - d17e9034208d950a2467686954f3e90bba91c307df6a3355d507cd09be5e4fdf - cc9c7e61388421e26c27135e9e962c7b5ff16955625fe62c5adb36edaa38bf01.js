...
CultivateImmortalityService.prototype = {
    ...
    _ExecBattleMonster(useraddress, monsterId) {
        ...
        for (var i = 0; i < this.BattleMaxRound; i++) {
            userItem.HP -= Math.min(monsterItem.MonsterAttach - userItem.Defense,0);
            monsterItem.MonsterHP -= Math.min(userItem.Attach - monsterItem.MonsterDefense,0);
    ...
    QueryBattleResult: function (blockheight) {
        ...
        return {"result":BattleResults,"blockheight":currentBlockHeight};
    },
