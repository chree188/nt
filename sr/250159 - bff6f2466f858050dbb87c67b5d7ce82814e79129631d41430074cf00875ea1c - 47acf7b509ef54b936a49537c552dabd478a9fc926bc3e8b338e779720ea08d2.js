//n1kvqHs3pznhizNbobMsJs4aGoj5mEpKGF4
'use strict';
...
Game.prototype = {
    ...
    _process_3: function(revealed){
        ...
        if (this._state == 10){
            ...
            if( this._winner_A(A, B) ){
                ...
                var x = this._records_date;
                x.push(Blockchain.block.height);
                this._records_date = x;

                var x = this._records_winner;
                x.push(this._addr_A);
                this._records_winner = x;

                var x = this._records_loser;
                x.push(this._addr_B);
                this._records_loser = x;
    ...
    get_all:function(){
        var jn = {"stake": this._stake,
                  "stale": this._stale,
                  "state": this._state,
                  "last_block": this._last_block,
                  "cur_block": Blockchain.block.height,
                  "addr_A": this._addr_A,
                  "hidden_A": this._hidden_A,
                  "revealed_A": this.revealed_A,
                  "addr_B": this._addr_B,
                  "hidden_B": this._hidden_B,
                  "revealed_B": this._revealed_B,
                  "winners": this._records_winner,
                  "losers": this._records_loser,
                  "date": this._records_date
                  }
