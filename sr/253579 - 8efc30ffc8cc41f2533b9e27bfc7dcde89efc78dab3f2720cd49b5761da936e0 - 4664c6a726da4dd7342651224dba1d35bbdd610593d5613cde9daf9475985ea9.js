...
var Estate = function () {
    ...
    //定义 地产总数 常量
    LocalContractStorage.defineProperty(this, "numberOfEstate"); //init 10000
    ...
    LocalContractStorage.defineProperty(this, "_defaultWeiPrice"); //init 1000000000000000000 1nas
 ...
 Estate.prototype = {
     ...
     init: function () {
         ...
         this._defaultWeiPrice = 1000000000000000000;
     },
      //获取房产数据
