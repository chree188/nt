...
InfoContract.prototype = {
    ...
    save : function (nickname, content) {
		...
		var value = Blockchain.transaction.value/1000000000000000000;
		...
		var index = this.size;
		this.arrayMap.put(index, info.timestamp);
		this.jlMap.put(info.timestamp, info);
		this.size +=1;
