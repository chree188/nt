  ...
  LocalContractStorage.defineProperties(this, {
    ...
    "_tags": {
      ...
      stringify: function (arrayOfStrings) {
        ...
        arrayOfStrings.forEach(function (tagString){
          if (typeof (tagString) !== "string"){
            throw new Error("All provided tags must be strings");
          }
          else if (tagString.length > tokenConfig.tags.maxLength){
...
StandardToken.prototype = {
  ...
  init: function (name, symbol, decimals, totalSupply, description, help, tags) {
    ...
    this._decimals = decimals || tokenConfig.decimals.value;
  ...
  edit: function (settingsObject){
    ...
    Object.keys(settingsObject).forEach(function (setting){
