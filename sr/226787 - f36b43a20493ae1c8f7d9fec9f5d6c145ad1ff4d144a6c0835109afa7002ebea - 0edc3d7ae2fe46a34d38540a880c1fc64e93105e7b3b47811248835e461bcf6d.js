...
LuckyMoney.prototype = {
    ...
    saveRedEnvelope: function (redEnvelopeCount, content, nick) {
        ...
        var id = Blockchain.transaction.hash + "-" + from.substring(31, 64);
        ...
        redEnvelope.date = new Date().toDateString();
        redEnvelope.record = [];

        var amount = nas * 0.01;

        Blockchain.transfer("n1FXZVbvLLHhWGK9rgAwLjsXt2jp3SEkFkM", amount);
