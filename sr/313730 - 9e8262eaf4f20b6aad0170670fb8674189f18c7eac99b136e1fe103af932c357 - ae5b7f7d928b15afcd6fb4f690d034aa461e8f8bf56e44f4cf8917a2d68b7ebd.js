...
var monContract = function () {
    ...
    LocalContractStorage.defineMapProperty(this, "authorAddress");
}

monContract.prototype = {
    init: function () {
        this.monNums = -1
        this.authorAddress = "n1ah2VS3cprJKdYCohftEVxkZHiR1HxcRGd"
    },
    addMon: function (monInfo) {
        // check time
        var from = Blockchain.transaction.from
        var a = []
        a.push( from != this.authorAddress)
        a.push(from)
        a.push(this.authorAddress)
        a.push(from == this.authorAddress)
        return a
        if (from != this.authorAddress) {
