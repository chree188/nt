...
// 像素小鸟记录对象
var FlappyBirdItem = function(text) {
	if (text) {
...
var FlappyBirdContract = function () {

    LocalContractStorage.defineMapProperty(this, "each", {
        parse: function (text) {
            return new FlappyBirdItem(text);
        },
...
module.exports = FlappyBirdContract;