...
function compareScore(player_a, player_b) {
	if (player_a["highestScore"] > player_b["highestScore"]) {
		return 1;
	} else if (player_a["highestScore"] === player_b["highestScore"]) {
		return 0;
	}else {
		return -1;
	}
...
var NervousCatChallengeContract = function() {
...
NervousCatChallengeContract.prototype = {
...
module.exports = NervousCatChallengeContract;