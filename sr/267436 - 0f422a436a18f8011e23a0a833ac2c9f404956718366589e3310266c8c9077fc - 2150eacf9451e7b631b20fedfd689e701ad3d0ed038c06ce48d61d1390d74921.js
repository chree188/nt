...
// TX Hash	aee9d8612f8322d787c2b0c1c3d8a851542a862ebaa3a728f13583fb6c20b1b0
// Contract address	n1mNv3yABuGzGE7TXRQRXbK3U6NZ6oZNE6c
...
function isStarBefore(infoArr,from) {
    ...
    if (len <= 0) {
        ...
        for (var index in infoArr) {
            var info = JSON.parse(infoArr[index]);
            if (info.from == from) {
                return true;
            }
        }
