...
StandardToken.prototype.recalculatePrices = function () {
  ...
  let goldPriceNAS = this.nasPrice ? this.goldPrice.div(this.nasPrice) : 1;
  ...
  let supplyCoverage = this.goldPrice ? this._contractBalance.div(totalSupplyNAS) : 1; // A number from 0 to ... If it is above 1, it is ok.
