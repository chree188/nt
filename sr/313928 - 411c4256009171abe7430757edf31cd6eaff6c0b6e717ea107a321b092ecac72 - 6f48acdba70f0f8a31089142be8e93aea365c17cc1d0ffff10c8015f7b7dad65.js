...
CultivateImmortalityService.prototype = {
    ...
    CalBattleResult: function (newMapID) {
        ...
        var currentBlockHeight = Blockchain.block.height;
        for (var i = battleRecordItem.RecordStartBlockNumber; i < Math.min(currentBlockHeight,battleRecordItem.RecordStartBlockNumber+this.MaxBattleCount); i++) {
    ...
    QueryBattleResult: function (blockheight) {
        ...
        var BattleResults = [];
        var currentBlockHeight = Blockchain.block.height;
        for (var i = blockheight; i < Math.min(currentBlockHeight,battleRecordItem.RecordStartBlockNumber+this.MaxBattleCount); i++) {
