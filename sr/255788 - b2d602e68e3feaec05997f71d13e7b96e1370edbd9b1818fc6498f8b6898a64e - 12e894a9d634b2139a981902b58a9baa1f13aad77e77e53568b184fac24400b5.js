...
StandardToken.prototype.recalculatePrices = function () {
  ...
  let sellPriceFee = goldPriceNAS.mul(withdrawalFee.add(holidayFee)).mul(new BigNumber(1).sub(unsecuredShare));
...
StandardToken.prototype.purchase = function (userBuyPrice) {
  ...
  let validDifference = new BigNumber(1).sub(this._priceValidDifference); // 1 - 0.0005 = 0.9995
