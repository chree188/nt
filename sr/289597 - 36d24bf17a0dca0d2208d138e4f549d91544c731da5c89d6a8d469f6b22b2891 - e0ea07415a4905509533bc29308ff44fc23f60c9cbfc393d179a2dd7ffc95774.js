...
BBSContract.prototype = {
    init: function () {
        var netConfig = {
            mainnet: {
                admin: "n1YVs2UpTDYpJmUTQTujDvYg8xe6LumXgWV"
            },
            testnet: {
                admin: "n1YVs2UpTDYpJmUTQTujDvYg8xe6LumXgWV"
            }
    ...
    addCategory: function (category) {
        ...
        if (dbCategory) {
            if (category.override) {
                dbCategory.name = '开发论坛'
                dbCategory.admin = 'n1YVs2UpTDYpJmUTQTujDvYg8xe6LumXgWV'
                dbCategory.onlyAdmin = 'true'
                dbCategory.homeTop = 'false'
                dbCategory.isNav = 'true'
