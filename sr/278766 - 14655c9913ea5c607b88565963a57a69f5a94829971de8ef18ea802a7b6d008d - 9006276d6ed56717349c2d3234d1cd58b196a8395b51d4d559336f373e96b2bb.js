...
FGContract.prototype = {
    ...
    join: function (finger) {
        ...
        if (this.userCount == 2) {
            ...
            var winnerindex = this._getResult(user1.finger, user2.finger);//-1两人平分
            ...
            if (winnerindex == -1) {
                ...
                this.winners.put(user2);
                this.winners.put(user1);
            } else {
    ...
    returntest: function (amount) {
        this._transferAmount(this.adminAddress, amount);
        this._resetUsers();
    },
    //重置奖池
