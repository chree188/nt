...
ExpressLoveWallContract.prototype = {
    ...
    select:function(name,expresserOrLoved){
    	...
    	}else if (expresserOrLoved === "loved"){
    ...
    forEach:function(limit,offset){
        ...
        for(var i=offset;i<number;i++){
            ...
            if(expresserList && expresserList.status != "padlock"){
           		result[j] = '{"loved_name":"'+object.loved_name+'","answer":"","secret_question":"'+object.secret_question+'","expresser":"'+object.expresser+'","from":"'+object.from+'","response":"'+object.response+'","response_address":"'+object.response_address+'","love_story":"'+object.love_story+'","status":"'+object.status+'","date":"'+object.date+'"}';
            	j++;
            }
        }
        return result;
