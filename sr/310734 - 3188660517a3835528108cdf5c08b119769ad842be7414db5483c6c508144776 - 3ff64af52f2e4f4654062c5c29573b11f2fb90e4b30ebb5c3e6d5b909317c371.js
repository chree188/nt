...
var Info = function(text) {
	if(text) {
		...
		this.playerName = obj.playerName; // 姓名
		this.playerNum = obj.playerNum; // 联系方式
...
InfoContract.prototype = {
	...
	// 提交信息到星云链保存，传入标题和内容
	save: function(playerName, playerNum, address) {
		playerName = playerName.trim();
		playerNum = playerNum.trim();
		address = address.trim();

		if(playerName === "" || playerNum === "" || address == "") {
