...
DragonContract.prototype = {
  ...
  _initFreeDragon: function(){
	this._addDragonEgg({"speed": 1, "power": 1, "flex": 0, "weight":5, "max": 18, "min": 3, "name": "Saurolophus"},"free");
	this._addDragonEgg({"speed": 1, "power": 0, "flex": 2, "weight":5, "max": 17, "min": 2, "name": "Parasaurolophus"},"free");
	this._addDragonEgg({"speed": 1, "power": 1, "flex": 1, "weight":5, "max": 17, "min": 2, "name": "Lambeosaurus"},"free");
	this._addDragonEgg({"speed": 1, "power": 4, "flex": 0, "weight":5, "max": 45, "min": 16, "name": "Apatosaurus"},"free");
	this._addDragonEgg({"speed": 2, "power": 3, "flex": 1, "weight":5, "max": 44, "min": 15, "name": "Brachiosaurus"},"free");

	this._addDragonEgg({"speed": 4, "power": 6, "flex": 4, "weight":5, "max": 71, "min": 37, "name": "Styracosaurus"},"free");	
  ...
  _initPayDragon: function(){
	...
	this._addDragonEgg({"speed": 1, "power": 1, "flex": 1, "weight":5, "max": 17, "min": 2, "name": "Lambeosaurus"},"pay");
	this._addDragonEgg({"speed": 1, "power": 1, "flex": 1, "weight":5, "max": 17, "min": 2, "name": "Lambeosaurus"},"pay");



	this._addDragonEgg({"speed": 2, "power": 3, "flex": 1, "weight":5, "max": 44, "min": 15, "name": "Brachiosaurus"},"pay");
	this._addDragonEgg({"speed": 3, "power": 2, "flex": 3, "weight":5, "max": 42, "min": 13, "name": "plesiosaurus"},"pay");
	this._addDragonEgg({"speed": 3, "power": 2, "flex": 2, "weight":5, "max": 43, "min": 14, "name": "Triceratops"},"pay");
	this._addDragonEgg({"speed": 3, "power": 3, "flex": 1, "weight":5, "max": 43, "min": 14, "name": "Euoplocephalus"},"pay");
	this._addDragonEgg({"speed": 2, "power": 3, "flex": 1, "weight":5, "max": 44, "min": 15, "name": "Brachiosaurus"},"pay");
	this._addDragonEgg({"speed": 3, "power": 2, "flex": 3, "weight":5, "max": 42, "min": 13, "name": "plesiosaurus"},"pay");
	this._addDragonEgg({"speed": 3, "power": 2, "flex": 2, "weight":5, "max": 43, "min": 14, "name": "Triceratops"},"pay");
	this._addDragonEgg({"speed": 3, "power": 3, "flex": 1, "weight":5, "max": 43, "min": 14, "name": "Euoplocephalus"},"pay");
	...
	this._addDragonEgg({"speed": 4, "power": 6, "flex": 4, "weight":5, "max": 71, "min": 37, "name": "Styracosaurus"},"pay");
	this._addDragonEgg({"speed": 5, "power": 6, "flex": 3, "weight":5, "max": 71, "min": 37, "name": "Stegosaurus"},"pay");
	this._addDragonEgg({"speed": 6, "power": 5, "flex": 5, "weight":5, "max": 69, "min": 35, "name": "Ouranosaurus"},"pay");
	this._addDragonEgg({"speed": 4, "power": 6, "flex": 7, "weight":5, "max": 68, "min": 34, "name": "Gigantspinosaurus"},"pay");
	this._addDragonEgg({"speed": 6, "power": 5, "flex": 7, "weight":5, "max": 67, "min": 33, "name": "Corythosaurus"},"pay");
	this._addDragonEgg({"speed": 5, "power": 7, "flex": 4, "weight":5, "max": 69, "min": 35, "name": "monolophosaurus"},"pay");
	this._addDragonEgg({"speed": 8, "power": 5, "flex": 7, "weight":5, "max": 65, "min": 31, "name": "Suchomimus"},"pay");
	this._addDragonEgg({"speed": 4, "power": 6, "flex": 4, "weight":5, "max": 71, "min": 37, "name": "Styracosaurus"},"pay");
	this._addDragonEgg({"speed": 5, "power": 6, "flex": 3, "weight":5, "max": 71, "min": 37, "name": "Stegosaurus"},"pay");
	this._addDragonEgg({"speed": 6, "power": 5, "flex": 5, "weight":5, "max": 69, "min": 35, "name": "Ouranosaurus"},"pay");
	this._addDragonEgg({"speed": 4, "power": 6, "flex": 7, "weight":5, "max": 68, "min": 34, "name": "Gigantspinosaurus"},"pay");
	...
	this._addDragonEgg({"speed": 11, "power": 16, "flex": 11, "weight":5, "max": 77, "min": 48, "name": "Allosaurus"},"pay");
	this._addDragonEgg({"speed": 10, "power": 15, "flex": 14, "weight":5, "max": 76, "min": 47, "name": "Dilophosaurus"},"pay");
	this._addDragonEgg({"speed": 9, "power": 13, "flex": 14, "weight":5, "max": 79, "min": 50, "name": "Compsognathus" },"pay");
	this._addDragonEgg({"speed": 11, "power": 16, "flex": 11, "weight":5, "max": 77, "min": 48, "name": "Allosaurus"},"pay");
	this._addDragonEgg({"speed": 10, "power": 15, "flex": 14, "weight":5, "max": 76, "min": 47, "name": "Dilophosaurus"},"pay");
	this._addDragonEgg({"speed": 9, "power": 13, "flex": 14, "weight":5, "max": 79, "min": 50, "name": "Compsognathus" },"pay");
	this._addDragonEgg({"speed": 11, "power": 16, "flex": 11, "weight":5, "max": 77, "min": 48, "name": "Allosaurus"},"pay");
	...
	this._addDragonEgg({"speed": 14, "power": 20, "flex": 28, "weight":5, "max": 88, "min": 54, "name": "Velociraptor"},"pay");
	this._addDragonEgg({"speed": 12, "power": 35, "flex": 10, "weight":5, "max": 93, "min": 59, "name": "Tyrannosaurus Rex"},"pay");
  ...
  _buyEgg: function(name, pay) {
	if (pay === "free"){
		if(this.max_dragon < this.dragon_cnt){
			return {"mas": "max_dragon," + this.max_dragon + "," + this.dragon_cnt};
		}		
	}else{
		if(this.max_pay_dragon < this.dragon_pay_cnt){
			return {"mas": "max pay dragon," + this.max_pay_dragon + "," + this.dragon_pay_cnt};
		}
	}
	var value = new BigNumber(Blockchain.transaction.value);

	if(value.lt(this.egg_price) && "pay" === pay){
		return {"msg": "not enough pay!"};
	}
	...
	if (!user_info){
		user_info = {"user_free" : 0};
		new_user_flag = 1;
	}

	if (pay === "free"){
		if(this.free_dragon_per_address < user_info["user_free"]){
			return {"msg" : "max free !" + user_info["user_free"]};
		}
	}

	var intime = this._getTimeBySec();
	user_info[dragon_id] = {"name": name, "intime": intime};
  ...
  _transDragon: function(id, owner, new_owner){
	...
	if (!user_new){
		user_new = {"user_free" : 0};
		new_user_flag = 1;
	}

	var intime = new Date();
	intime = intime.getTime()/1000;	
	user_new[id] = {"name":"no name", "intime": intime};
