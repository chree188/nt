...
TurnTableContract.prototype = {
    ...
    reCharge: function () {
        ...
        this._addUser(from + this.count, from + "充值了" + Blockchain.transaction.value/1e18 + "NAS");
    },
    ...
    afterAward: function (value) {
        ...
        if(new BigNumber(value).gt(new BigNumber(0))){
            this._addUser(from + this.count, from + "中奖了" + value/1e18 + "NAS");
        }
    },
    ...
    withDrawAll: function () {
        ...
        this._addUser(from + this.count, from + "提现了" + amount/1e18 + "NAS");
    },
