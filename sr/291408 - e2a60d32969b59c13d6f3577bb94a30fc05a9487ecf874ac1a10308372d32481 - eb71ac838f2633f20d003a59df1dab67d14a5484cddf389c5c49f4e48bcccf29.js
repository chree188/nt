...
NofishRanking.prototype = {
    ...
    createRank: function (name, desc, items, max_voter, banner_url) {
    ...
    vote: function () {
        // [{
        //     voter_name: 'voter name1',
        //     item_name: 'a'
        // },{
        //     voter_name: 'voter name2',
        //     item_name: 'b'
            
        // },{
        //     voter_name: 'voter name3',
        //     item_name: 'c' 
        // }]
    },
    inviteVoter: function (rank_key, name, description) {
        // name description rank_name
        // 插入到 rank voters
        let rankItem = JSON.parse(this.RankItemsMap.get(rank_key));
        var voter = {"name": name, "desc": description};
        rankItem.voters = voter;
        // rankItem.voters.push(voter);
        this.RankItemsMap.put(rank_key, rankItem);
        return this.RankItemsMap.get(rank_key)
    }
