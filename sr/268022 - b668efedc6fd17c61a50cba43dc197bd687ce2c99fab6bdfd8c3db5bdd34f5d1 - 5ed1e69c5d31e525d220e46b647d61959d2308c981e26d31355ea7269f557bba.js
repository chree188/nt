...
var LongZhuContract = function () {

    LocalContractStorage.defineMapProperty(this, "each", {
        parse: function (text) {
            return new LongZhuItem(text);
        },
...
module.exports = LongZhuContract;