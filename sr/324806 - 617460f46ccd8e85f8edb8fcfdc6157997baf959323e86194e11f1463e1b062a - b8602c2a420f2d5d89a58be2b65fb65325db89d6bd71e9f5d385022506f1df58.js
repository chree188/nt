...
NebulasGameToken.prototype = {
    ...
    init: function(tokenName, tokenSymbol, decimals, totalSupply, tokenPrice) {
        ...
        this.today = "";
        this.signCnt = 0;
        this._allowSupply = this.totalSupply;
        mylog("init this._allowSupply:", this._allowSupply);
        this._signCnt = 100;
        this._signNGT = 100;
    ...
    withdrow: function(value) {
        ...
        mylog('withdrow value nas:', value);
        value = NAS2WEI(value);
        mylog('withdrow value wei:', value);
        var result = Blockchain.transfer(this.admin, value);

        mylog(`transfer to ${from}:`, value);
    }
};
