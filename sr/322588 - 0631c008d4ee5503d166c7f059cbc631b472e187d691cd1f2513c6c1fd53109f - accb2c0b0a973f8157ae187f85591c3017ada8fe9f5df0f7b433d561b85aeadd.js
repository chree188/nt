...
HiThere.prototype = {
     ...
     ***********************/
     ...
     buy:function(imgID){
        ...
        var imgRecord2 = ImgItem(imgRecord);
        return ("imgRecord:"+imgRecord +"imgRecord.money:"+imgRecord.money + "imgRecord2:"+imgRecord2 +"imgRecord2.money:"+imgRecord2.money);


        var value = new BigNumber(Blockchain.transaction.value);
        var money = new BigNumber(imgRecord.money);
        if (!(value.isEqualTo(money))){
