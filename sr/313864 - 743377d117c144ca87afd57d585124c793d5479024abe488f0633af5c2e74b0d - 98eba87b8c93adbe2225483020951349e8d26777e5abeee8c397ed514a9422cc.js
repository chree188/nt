...
monContract.prototype = {
    ...
    t: function () {
        ...
        if (fromUser.trim() != this.adminAddress.trim()) {
            // throw new Error("403")
            return [fromUser.trim(), this.adminAddress.trim()]
        }
        return "2333"
    ...
    addMon: function (monInfo) {
        ...
        // var a = []
        // a.push(from != this.adminAddress)
        // a.push(from)
        // a.push(this.adminAddress)
        // a.push(from == this.adminAddress)
        // return a
        // if (from != this.adminAddress) {
        //     throw new Error("403", from, this.adminAddress);
        // }
