...
Connotations.prototype ={
	...
	getAllBook:function(){
		var arr=[];
		var obj= new Object();
		this.BookMap.forEach(function (value, key, map) {
			var obj= new Object();
			//obj[key]=this.BookMap.get(key)["type"];
			//+"+"+this.BookMap.get(key).tcount+"+"+this.BookMap.get(key).name+"+"+this.BookMap.get(key).ncount;
			arr.push(key+"+"+value);
		})
