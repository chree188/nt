...
XHEmailContract.prototype = {
    init: function() {
        this.emailCount = 3;
        var emailInfo = new XHEmailInfo();
    ...
    getEamil: function(offset) {
        var limit = 4;
        var start = this.emailCount - offset * limit
        var end = this.emailCount - (offset + 1) * limit
...
module.exports = XHEmailContract;